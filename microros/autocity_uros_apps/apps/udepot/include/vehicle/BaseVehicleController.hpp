 ...
 * @LastEditors: hanson
 * @LastEditTime: 2024-11-28 18:30:02
 * @Description:
...
namespace auto_city
{
    namespace udepot
    {
        template <typename MessageCMD>
        class BaseVehicleController
        {
        protected:
            /* data */
            MessageCMD *_control_cmd_msg;
        ...
        public:
            ...
            virtual int Setup(std::unordered_map<uint32_t, BaseProtocol *> &protocol_map, MessageCMD *msg, ChassisDetail *chassis) = 0;
