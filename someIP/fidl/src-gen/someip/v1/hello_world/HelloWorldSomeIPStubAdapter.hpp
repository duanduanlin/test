 ...
 */
#ifndef V1_HELLO_WORLD_HELLO_WORLD_SOMEIP_STUB_ADAPTER_HPP_
#define V1_HELLO_WORLD_HELLO_WORLD_SOMEIP_STUB_ADAPTER_HPP_

#include <v1/hello_world/HelloWorldStub.hpp>
#include <v1/hello_world/HelloWorldSomeIPDeployment.hpp>
...
template <typename _Stub = ::v1::hello_world::HelloWorldStub, typename... _Stubs>
...
public:
    ...
    HelloWorldSomeIPStubAdapterInternal(
        ...
        sayHelloStubDispatcher(
            ...
            false,
            _stub->hasElement(0),
            std::make_tuple(&::v1::hello_world::HelloWorld_::sayHello_nameDeployment),
...
#endif // V1_HELLO_WORLD_Hello_World_SOMEIP_STUB_ADAPTER_HPP_
