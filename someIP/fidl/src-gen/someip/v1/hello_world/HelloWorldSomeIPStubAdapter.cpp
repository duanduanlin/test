 ...
 */
#include <v1/hello_world/HelloWorldSomeIPStubAdapter.hpp>
#include <v1/hello_world/HelloWorld.hpp>
...
std::shared_ptr<CommonAPI::SomeIP::StubAdapter> createHelloWorldSomeIPStubAdapter(
    ...
    return std::make_shared< HelloWorldSomeIPStubAdapter<::v1::hello_world::HelloWorldStub>>(_address, _connection, _stub);
}

void initializeHelloWorldSomeIPStubAdapter() {
    CommonAPI::SomeIP::AddressTranslator::get()->insert(
        "local:hello_world.HelloWorld:v1_0:hello_world.HelloWorld",
         0x1234, 0x1234, 1, 0);
    CommonAPI::SomeIP::Factory::get()->registerStubAdapterCreateMethod(
        "hello_world.HelloWorld:v1_0",
