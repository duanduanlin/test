 ...
 */
#include <v1/hello_world/HelloWorldSomeIPProxy.hpp>
...
void HelloWorldSomeIPProxy::sayHello(std::string _name, CommonAPI::CallStatus &_internalCallStatus, std::string &_message, const CommonAPI::CallInfo *_info) {
    CommonAPI::Deployable< std::string, CommonAPI::SomeIP::StringDeployment> deploy_name(_name, &::v1::hello_world::HelloWorld_::sayHello_nameDeployment);
