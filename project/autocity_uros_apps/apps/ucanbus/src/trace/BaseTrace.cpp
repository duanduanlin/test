 ...
 * @LastEditors: hanson
 * @LastEditTime: 2024-10-09 13:39:08
 * @Description:
 * @FilePath: \autocity_uros_apps\apps\ucanbus\src\trace\BaseTrace.cpp
 */
#include <thread>
#include <ctime>
#include <random>
...
BaseTrace::BaseTrace(std::string file_name)
{
    ...
    {
        ROS_LOG_DIR = std::string("/autocity/data/logs/latest/ucanbus");
    }
    else
    {
