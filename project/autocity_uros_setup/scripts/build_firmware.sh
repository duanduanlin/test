...
###
 ...
 # @LastEditors: hanson
 # @LastEditTime: 2024-08-08 15:33:22
 # @Description:
 # @FilePath: /hanson/uros_ws/src/autocity_uros_setup/scripts/build_firmware.sh
###
...
do
    case "$o" in
        ...
        v)
            ...
            ;;
        [?])
            echo "Usage: ros2 run autocity_uros_setup build_firmware.sh [options] -- [build_args]"
            echo "Options:"
