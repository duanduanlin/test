...
###
 ...
 # @LastEditors: hanson
 # @LastEditTime: 2024-08-09 11:15:22
 # @Description:
 # @FilePath: /hanson/uros_ws/src/autocity_uros_setup/scripts/create_ws.sh
###
...
curl -s https://raw.githubusercontent.com/ros2/ros2/humble/ros2.repos |\
    ros2 run autocity_uros_setup yaml_filter.py ${PACKAGES} > ros2.repos
