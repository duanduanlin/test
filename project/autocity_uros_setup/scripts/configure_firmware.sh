...
###
 ...
 # @LastEditors: hanson
 # @LastEditTime: 2024-08-08 15:33:54
 # @Description:
 # @FilePath: /hanson/uros_ws/src/autocity_uros_setup/scripts/configure_firmware.sh
###
...
export PREFIX=$(ros2 pkg prefix autocity_uros_setup)
...
if [ $# -lt 1 ]; then
  echo "micro-ROS application name must be provided: ros2 run autocity_uros_setup configure_firmware.sh [app name] [options]"
